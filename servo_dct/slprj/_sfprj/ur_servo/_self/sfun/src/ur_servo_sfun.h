#ifndef __ur_servo_sfun_h__
#define __ur_servo_sfun_h__
...
extern mxArray* load_ur_servo_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_ur_servo_optimization_info(void);
